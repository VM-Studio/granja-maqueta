...
export default function QuesosPage() {
  const products = [
    { name: "Queso Cremoso", price: "$X.XXX", desc: "Untable 500g" },
    { name: "Queso Tybo", price: "$X.XXX", desc: "Horma por kg" },
    { name: "Queso Sardo", price: "$X.XXX", desc: "Para rallar kg" },
    { name: "Queso Azul", price: "$X.XXX", desc: "Premium 250g" },
    { name: "Queso Provolone", price: "$X.XXX", desc: "Ahumado kg" },
    { name: "Queso Barra", price: "$X.XXX", desc: "Para sándwich kg" },
  ];
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-10 sm:mb-12 lg:mb-16">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 sm:mb-6">
              <span className="text-[#2f1f1c]">Quesos </span>
              <span className="bg-gradient-to-r from-[#ee920f] to-[#d68310] bg-clip-text text-transparent">y Quesería</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-4">
              Selección especial de quesos artesanales y variedades importadas.
            </p>
          </div>
