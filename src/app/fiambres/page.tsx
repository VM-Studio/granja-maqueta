...
export default function FiambresPage() {
  const products = [
    { name: "Jamón Cocido", price: "$X.XXX", desc: "Premium cocido" },
    { name: "Jamón Crudo", price: "$X.XXX", desc: "Curado artesanal" },
    { name: "Salame", price: "$X.XXX", desc: "Tipo Milan" },
    { name: "Mortadela", price: "$X.XXX", desc: "Con aceitunas" },
    { name: "Salchichón", price: "$X.XXX", desc: "Especial parrilla" },
    { name: "Bondiola", price: "$X.XXX", desc: "Ahumada" },
  ];
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-10 sm:mb-12 lg:mb-16">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 sm:mb-6">
              <span className="text-[#2f1f1c]">Fiambres </span>
              <span className="bg-gradient-to-r from-[#ee920f] to-[#d68310] bg-clip-text text-transparent">y Embutidos</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-4">
              Amplia variedad de fiambres y embutidos de primera calidad.
            </p>
          </div>
