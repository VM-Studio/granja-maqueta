...
export default function LacteosPage() {
  const products = [
    { name: "Leche Fresca", price: "$X.XXX", desc: "Entera 1L" },
    { name: "Yogur Natural", price: "$X.XXX", desc: "Cremoso 1kg" },
    { name: "Manteca", price: "$X.XXX", desc: "Con sal 200g" },
    { name: "Crema de Leche", price: "$X.XXX", desc: "Para cocinar 500ml" },
    { name: "Dulce de Leche", price: "$X.XXX", desc: "Casero 450g" },
    { name: "Ricota", price: "$X.XXX", desc: "Fresca 500g" },
  ];
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-10 sm:mb-12 lg:mb-16">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 sm:mb-6">
              <span className="text-[#2f1f1c]">Lácteos </span>
              <span className="bg-gradient-to-r from-[#ee920f] to-[#d68310] bg-clip-text text-transparent">y Derivados</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto px-4">
              Productos lácteos frescos y cremosos para toda la familia.
            </p>
          </div>
